...
class Apex8PredictorC(Predictor):
    """apex7 + K * ticket2, row-demeaned.  K is a fixed offline constant."""

    K = 0.068664           # (w/(1-w)) * (sigma_a7/sigma_t2) at w = 0.15
    ...
    SCALE_T = 0.60800000   # fixed: median per-period avg cs-std, TF leg
    ...
    def train(self, features: pd.DataFrame, target: pd.DataFrame) -> None:
        # BOTH sub-models are warm-started on exactly the rows handed in here:
