...
# ///
"""Competition 5 — CatBoost + lead-lag graph, TWO legs at frozen equal risk.
...
class CatGraphPredictor(Predictor):
    """Lead-lag graph + CatBoost, equal risk, zero fitted weights."""
