"""Competition 5 — basic gradient-boosted cross-sectional ranker (AdaBoost).
...
class GbmAdaPredictor(Predictor):
    """One AdaBoost model on rank features -> csrank -> row de-mean."""
    ...
    def train(self, features: pd.DataFrame, target: pd.DataFrame) -> None:
        ...
        self.model = AdaBoostRegressor(
            ...
            n_estimators=self.ROUNDS, learning_rate=self.LR,
